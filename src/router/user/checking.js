...
import { checkName, checkAccount, checkPassword, checkHeaderImg, checkRemark } from '../../lib/rules/index.js'
...
export const checkCreateUser = ({ name, account, password, headerImg, remark }) => {
    const resultArr = [
        checkName(name),
...
export const checkUpdateUser = ({ id, name, password, headerImg, remark }) => {
